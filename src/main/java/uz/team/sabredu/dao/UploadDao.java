...
public class UploadDao implements Dao<Upload> {
    @Override
    ...
    public Optional<Upload> findByGeneratedName(String filename) {
        Session session = HibernateConfigurer.getSession();
        return Optional.ofNullable(
                session.createQuery("select t from Upload t where t.generatedName = :generatedName", Upload.class)
